...
namespace siofraEngine::systems
{
    ...
    public:
         ...
         */
        virtual void transitionImageLayout(IVulkanCommandBuffer const * transferCommandBuffer, IVulkanQueue const * transferQueue, VkImageLayout oldLayout, VkImageLayout newLayout) const = 0;
